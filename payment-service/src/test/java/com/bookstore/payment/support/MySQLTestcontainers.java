...
public final class MySQLTestcontainers {
    ...
    public static final MySQLContainer<?> MYSQL = new MySQLContainer<>(IMAGE)
            .withDatabaseName("bookstore_payment_db")
    ...
    public static void registerDatasourceProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("stripe.secret-key", () -> "sk_test_payment_service");
        registry.add("stripe.webhook-secret", () -> "whsec_test_payment_service");
        registry.add("spring.kafka.bootstrap-servers", () -> "localhost:9092");
        registry.add("spring.kafka.listener.auto-startup", () -> "false");
        registry.add("services.book-service.url", () -> "http://localhost:8083");
        registry.add("services.user-service.url", () -> "http://localhost:8082");
    }
}
